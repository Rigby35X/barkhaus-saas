...
export default function AnimalForm({ puppy, onSave, onCancel }: AnimalFormProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl m-4 max-h-[90vh] overflow-hidden flex flex-col">
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-2xl font-bold text-deep-taupe">
            {puppy ? 'Edit Animal' : 'Add New Animal'}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-red-600 mb-1">
                      Animal's Original Name (from shelter)
                    </label>
                    <input
                      type="text"
          ...
          <div className="flex justify-end gap-3 mt-8 pt-6 border-t">
            ...
            >
              {puppy ? 'Update Animal' : 'Create Animal'}
            </button>
          </div>
        </form>
      </div>
